...
def test_model_all(test_loader, args):
    ...
    a1 = (l2error_avg_08s+l2error_avg_12s)/2
    a2 = l2error_avg_20s
    a3 = (l2error_avg_32s+l2error_avg_28s)/2
    a4 = l2error_overall

    f1 = (l2error_dest_08s+l2error_dest_12s)/2
    f2 = l2error_dest_20s
    f3 = (l2error_dest_28s+l2error_dest_32s)/2
    f4 = l2error_dest
    ...
    print('##################')
    return a1, a2, a3, a4, f1, f2, f3, f4

if __name__ == '__main__':
    parser = argparse.ArgumentParser()
    parser.add_argument('--seed', type=int, default=1)
    parser.add_argument('--model_names', default='100')
    parser.add_argument('--gpu', type=int, default=0)
    parser.add_argument('--model_save_dir', default='saved_models/nba')
    parser.add_argument('--vis', action='store_true', default=False)  #False
    ...
    for name in names:
        ...
        for i in range(10):
            a1, a2, a3, a4, f1, f2, f3, f4 = test_model_all(test_loader, args)
            maxa1 = min(maxa1, a1)
            maxa2 = min(maxa2, a2)
            maxa3 = min(maxa3, a3)
            maxa4 = min(maxa4, a4)
            ...
            maxf4 = min(maxf4, f4)
        print('##################')
        print('ADE 1.0s:', (maxa1, maxf1))
        print('ADE 2.0s:', (maxa2, maxf2))
        print('ADE 3.0s:', (maxa3, maxf3))
        print('ADE 4.0s:', (maxa4, maxf4))
        print('##################')
