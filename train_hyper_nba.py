...
parser.add_argument('--lr', type=float, default=1.0e-3)  #1e-4
...
parser.add_argument('--hyper_scales', nargs='+', type=int,default=[11])
...
def train(train_loader,epoch):
    ...
    for data in train_loader:
        total_loss,loss_pred,loss_recover,loss_kl,loss_diverse, pred_loss = model(data)
        """ optimize """
        optimizer.zero_grad()
        total_loss.backward()
        optimizer.step()
